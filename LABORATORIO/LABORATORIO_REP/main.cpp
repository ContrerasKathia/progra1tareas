...
/*int Marcador(int par_jugA[6],int par_jugB[6],int Par_ganA[6],int Par_ganB[6],int Par_perA[6],int Par_perB[6],int Par_empA[6],int Par_empB[6],int pos,int n);*/
...
void llamarCiclo()
{
    ...
    do
    {
        ...
        for (n=1;n<=5;n++)
        {
            ...
            /*Marcador(par_jugA,par_jugB,Par_ganA,Par_ganB,Par_perA,Par_perB,Par_empA,Par_empB,pos,n);*/
        ...
        for (int f=0;f<=5;f++)
        {
            if (nmarcador[f][4]==Gan )
            {
                cout<<"El Equipo "<<nombresEquipos[f]<<" Gano el campeonato con "<<Gan<<" puntos"<<endl<<endl;
            }
            if (nmarcador[f][4]==Per )
            {
                cout<<"El Equipo "<<nombresEquipos[f]<<" Baja de categoria con "<<Per<<" puntos"<<endl<<endl;
            }
        }
        cout<<endl<<endl;
